function colorModeToggle() {
  ...
  var toggleButton =scriptTag.getAttribute("toggleButton");
  if (!toggleButton) {
  ...
  var primaryLogo =scriptTag.getAttribute("primaryLogo");
  if (!primaryLogo) {
  ...
  var secondaryLogo =scriptTag.getAttribute("secondaryLogo");
  if (!secondaryLogo) {
